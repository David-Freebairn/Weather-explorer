"""
pages/7_Trend.py — Weather Explorer
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
station's record, as:
  ...
  2. Four periods — the same scatter, split into four roughly-equal
     historical periods (~30 years each, depending on how long the
     record is), each with its own independently-fitted trend segment.
     This surfaces whether the trend has been stable across the record
     or has sped up/slowed/reversed in different eras — a single
     all-years slope can hide that.
