"""
pages/5_Odds.py — Weather Explorer
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
across the station's record?

Ported from RiskAware's pages/2_Odds.py, adapted to Weather Explorer's
shared-station pattern (station picked once on Menu, no separate
per-page station search here). The analysis, chart, and JPEG export
logic below is otherwise unchanged from RiskAware's version. The
"start record" year control (how far back the analysis looks) is kept
as a page-specific input next to the confirmed-station banner.
"""
...
from core.silo import ensure_climate_cached, slice_climate, SiloUnavailableError, load_sample_data
